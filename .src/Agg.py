...
# General variables
station_file = 'Pivot_TMX_CON1.csv'  # Current IDEAM records file
station_path = 'C:/JLGC/R.LTWB/.datasets/IDEAM_EDA/'  # Current IDEAM records path, use ../.datasets/IDEAM_Impute/ for relative path
ENSOONI_file = 'ONI_Eval_Consecutive.csv'
ENSOONI_path = 'C:/JLGC/R.LTWB/.datasets/ENSOONI/'
path = 'C:/JLGC/R.LTWB/.datasets/IDEAM_Agg2/'  # Your local output files path, use ../.datasets/IDEAM_Agg/ for relative path
...
unit = 'Max temperature, °C'  # 'Rain, mm' 'Min temperature, °C' 'Max temperature, °C' 'Flow, m³/s' 'Potential evaporation, mm'
