...
# General variables
station_file = 'C:\JLGC\R.LTWB\.datasets\IDEAM/IDEAMJoined.csv'  # Current IDEAM records file
#station_file = 'C:/Temp/chirps/IDEAMJoinedJL.csv'  # Current IDEAM records file
path = 'C:\JLGC\R.LTWB\.datasets\CHIRPS/'  # Your local output path, use ../.datasets/CHIRPS/ for relative path
...
year_end = 2022  # This value have to correspond with the end of the IDEAM series
