...
# General variables
pivot_table_name = 'Outlier_IQR_Cap_Pivot_PTPM_TT_M_P.csv'  # <<<<< Pivot table name to process
path_input = 'C:/JLGC/R.LTWB/.datasets/IDEAM_Outlier/'  # Current location from pivot tables
station_file = path_input + pivot_table_name  # Current pivot IDEAM records file for a specified parameter
path = 'C:/JLGC/R.LTWB/.datasets/IDEAM_ImputeP/'  # Your local output path, use ../.datasets/IDEAM_Impute/ for relative path
...
station_exclude = ['21200710', '21201090', '21201130', '21201380', '21201620', '21201720', '21201750', '21201760', '21201790', '21200800', '21201840', '21206070', '21230080', '23060040', '24010380', '21206100', '35060280', '35067050']  # Use ['station1', 'station2', '...',]
station_include = ['35070110']  # Use ['station1', 'station2', '...',]
